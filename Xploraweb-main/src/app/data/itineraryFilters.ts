...
export const STOP_COUNT_BUCKETS: WalkLengthOption[] = [
...
export function getEffectiveStopRange(bucket: WalkLengthOption, restaurantHopping: boolean): { minStops: number; maxStops: number } {
