  ...
  const types = [
    {
      ...
      link: '/itinerary?category=xplorators',
    },
    {
      icon: Users,
      ...
      link: '/itinerary?category=xploratours',
    },
    {
      icon: Moon,
      ...
      link: '/itinerary?category=xploranights',
    },
    {
      icon: Sparkles,
      ...
      link: '/itinerary?category=xploratorsplus',
    },
  ];
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8 py-14 space-y-20">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {types.map(({ icon: Icon, title, desc, accent, link }) => (
              <Link
                key={link}
                to={link}
                className="group bg-card border border-border rounded-2xl p-5 flex flex-col gap-3 hover:shadow-md transition-shadow"
              >
