      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 pt-12 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/50 leading-relaxed">Self-guided neighbourhood tours in Québec City.</p>
            <div className="flex gap-3 mt-5">
              ...
              <a href="#" aria-label="TikTok" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition">
              ...
              <a href="#" aria-label="X / Twitter" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition">
