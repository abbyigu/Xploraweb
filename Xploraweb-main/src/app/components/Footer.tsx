        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://www.instagram.com/goxplora.qc" target="_blank" rel="noopener noreferrer" aria-label={t('a11y.followInstagram')} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition">
              ...
              <a href="https://www.facebook.com/profile.php?id=61589277074215" target="_blank" rel="noopener noreferrer" aria-label={t('a11y.followFacebook')} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li><Link to="/privacy" className="hover:text-white transition">{t('footer.linkPrivacyPolicy')}</Link></li>
              <li><Link to="/terms" className="hover:text-white transition">{t('footer.linkTermsOfService')}</Link></li>
              <li><a href="#" className="hover:text-white transition">{t('footer.linkCookiePolicy')}</a></li>
              <li><a href="#" className="hover:text-white transition">{t('footer.linkAccessibility')}</a></li>
            </ul>
          </div>
        </div>
